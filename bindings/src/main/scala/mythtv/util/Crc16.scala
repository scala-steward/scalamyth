...
/** CRC-16 CCITT (X.25 variant)
  * as used by the Qt function qChecksum
  *
  * polynomial 0x1021 (x^0 + x^5 + x^12 + x^16) with init=0xffff and final XOR with 0xffff
  *
  * see http://reveng.sourceforge.net/crc-catalogue/16.htm#crc.cat.x-25
  * for the entry in the "CRC Catalogue"
  *
  * precomputed lookup table borrowed from the Linux kernel sources
